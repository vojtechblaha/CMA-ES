...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--max_generations", type=int, default=100000)
    parser.add_argument("--max_true_evals", type=int, default=10100)
    parser.add_argument("--sigma0", type=float, default=10.0)
    parser.add_argument("--pop_size", type=int, default=26)
    ...
    parser.add_argument("--recent_fraction", type=float, default=0.1)
    parser.add_argument("--top_fraction", type=float, default=0.6)
